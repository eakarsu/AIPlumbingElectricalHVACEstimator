...
// Custom Feature: AI job estimator
// AI job estimator: Photo/video of job site + job description; AI generates itemized quote (materials, labor hours, disposal); auto-calculates markup; generates professional proposal
import React, { useState } from 'react';

export default function CFAiJobEstimatorPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-job-estimator/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI job estimator</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>AI job estimator: Photo/video of job site + job description; AI generates itemized quote (materials, labor hours, disposal); auto-calculates markup; generates professional proposal</p>
