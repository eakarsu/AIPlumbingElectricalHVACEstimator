...
// Custom Feature: Code compliance automation
// Code compliance automation: Route material/design through code checker; flag violations by jurisdiction; suggest compliant alternatives
import React, { useState } from 'react';

export default function CFCodeComplianceAutomationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-code-compliance-automation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Code compliance automation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Code compliance automation: Route material/design through code checker; flag violations by jurisdiction; suggest compliant alternatives</p>
