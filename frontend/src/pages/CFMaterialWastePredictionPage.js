...
// Custom Feature: Material waste prediction
// Material waste prediction: Batch material orders; AI predicts waste (plumbing job = 15% scrap); suggests purchasing efficiency or recycle options
import React, { useState } from 'react';

export default function CFMaterialWastePredictionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-material-waste-prediction/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Material waste prediction</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Material waste prediction: Batch material orders; AI predicts waste (plumbing job = 15% scrap); suggests purchasing efficiency or recycle options</p>
