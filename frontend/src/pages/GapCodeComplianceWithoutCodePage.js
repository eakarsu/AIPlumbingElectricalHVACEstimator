...
// Gap (AI): Code compliance without '/code
// Code compliance without /code-compliance-check-ai (NLP rule interpretation)
import React, { useState } from 'react';

export default function GapCodeComplianceWithoutCodePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-code-compliance-without-code/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Code compliance without '/code</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Code compliance without /code-compliance-check-ai (NLP rule interpretation)</p>
