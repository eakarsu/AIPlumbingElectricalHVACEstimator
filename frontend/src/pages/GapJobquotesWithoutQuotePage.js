...
export default function GapJobquotesWithoutQuotePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-jobquotes-without-quote/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>JobQuotes without '/quote</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>JobQuotes without /quote-estimate-ai (auto-generate material list from job description)</p>
