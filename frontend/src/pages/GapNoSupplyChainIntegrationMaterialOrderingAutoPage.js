...
// Gap (Non-AI): No supply chain integration (material ordering automation)
// No supply chain integration (material ordering automation)
import React, { useState } from 'react';

export default function GapNoSupplyChainIntegrationMaterialOrderingAutoPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-supply-chain-integration-material-ordering-auto/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No supply chain integration (material ordering automation)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No supply chain integration (material ordering automation)</p>
